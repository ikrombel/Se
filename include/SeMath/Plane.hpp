...
public:
    ...
    /// Return as a vector.
    inline Vector4 ToVector4() const { return Vector4(normal_, d_); }
...
inline const Plane Plane::UP(Vector3(0.0f, 1.0f, 0.0f), Vector3(0.0f, 0.0f, 0.0f));

inline Matrix3x4 Plane::ReflectionMatrix() const
{
    return Matrix3x4(
